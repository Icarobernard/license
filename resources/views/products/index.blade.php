                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <a href="{{ $index > 0 ? route('products.moveUp', $product->id) : '#' }}"
                                            ...
                                            <a href="{{ $index < $products->count() - 1 ? route('products.moveDown', $product->id) : '#' }}"
                                                class="btn btn-link {{ $index === $products->count() - 1 ? 'disabled' : '' }}"
                                                data-bs-toggle="tooltip"
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <!-- Link para editar -->
                                            <a href="{{ route('products.find', $product->id) }}" class="mx-2" data-bs-toggle="tooltip" data-bs-original-title="Editar produto">
