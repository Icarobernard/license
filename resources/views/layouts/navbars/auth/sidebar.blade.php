<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      ...
      <span class="ms-3 font-weight-bold">Gestor de licenças </span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('vitrine') ? 'active' : '') }}" href="{{ url('vitrine') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <!-- <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>shop </title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <svg width="12px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
          ...
          <span class="nav-link-text ms-1">Área de membros</span>
        </a>
      </li>
      </li>
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('dominios') ? 'active' : '') }}" href="{{ url('dominios') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
          ...
          <span class="nav-link-text ms-1">Gerenciar domínios</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('users') ? 'active' : '') }}" href="{{ url('users') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
          ...
          <span class="nav-link-text ms-1">Lista de usuários</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('licenses') ? 'active' : '') }}" href="{{ url('licenses') }}">
          ...
          <span class="nav-link-text ms-1">Gerenciar Licenças</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('produtos') ? 'active' : '') }}" href="{{ url('produtos') }}">
          ...
          <span class="nav-link-text ms-1">Configurar produtos</span>
        </a>
      </li>
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('ofertas') ? 'active' : '') }}" href="{{ url('ofertas') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
              <path d="M40 48C26.7 48 16 58.7 16 72l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24L40 48zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L192 64zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-288 0zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-288 0zM16 232l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24l-48 0c-13.3 0-24 10.7-24 24zM40 368c-13.3 0-24 10.7-24 24l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24l-48 0z" />
            </svg>
          </div>
          <span class="nav-link-text ms-1">Configurar ofertas</span>
        </a>
      </li>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('logs') ? 'active' : '') }}" href="{{ url('logs') }}">
          ...
          <span class="nav-link-text ms-1">Erros de pagamento</span>
        </a>
      </li>
  ...
  <div class="sidenav-footer mx-3 ">
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      ...
      <div class="card-body text-start p-3 w-100">
        ...
        <div class="docs-info">
          <h6 class="text-white up mb-0">Bem-vindo!</h6>
          <p class="text-xs font-weight-bold">Sistema gestor de licenças</p>
