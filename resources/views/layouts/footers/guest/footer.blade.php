  ...
  <footer class="footer py-5">
    <div class="container">
      ...
      <div class="col-lg-8 mb-4 mx-auto text-center">
          <a href="https://negocioonlinedozero.com" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              Nodz
          </a>
          <a href="https://negocioonlinedozero.com/instagram/"  target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              Sobre nós
          </a>
          <a href="https://www.instagram.com/nodz_oficial/" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              Instagram
          </a>
        ...
        <div class="row">
          <div class="col-8 mx-auto text-center mt-1">
            <p class="mb-0 text-secondary">
              ...
              <a style="color: #252f40;" href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Nodz</a>
            </p>
          </div>
        </div>
      @endif
