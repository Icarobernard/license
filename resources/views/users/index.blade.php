            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{ route('users.create') }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+ Novo usuário</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <!-- Link para editar -->
                                            <a href="{{ route('users.edit', $user->id) }}" class="mx-2" data-bs-toggle="tooltip" data-bs-original-title="Editar usuário">
                                            ...
                                            <form action="{{ route('users.destroy', $user->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button data-bs-toggle="tooltip" data-bs-original-title="Deletar usuário" type="submit" class="btn btn-link text-danger m-1" onclick="return confirm('Certeza que quer deletar este usuário?')">
