                        ...
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab" aria-controls="dashboard" aria-selected="false">
                                    ...
                                    <span class="ms-1">{{ __('Configuração de conta') }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('user-profile.update') }}" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="current-password" class="form-control-label">Senha Atual</label>
                                <div class="@error('current_password')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="password" placeholder="Senha Atual" id="current-password" name="current_password">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="new-password" class="form-control-label">Nova Senha</label>
                                <div class="@error('new_password')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="password" placeholder="Nova Senha" id="new-password" name="new_password">
                                    @error('new_password')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                <label for="new-password" class="form-control-label">Confirmar senha</label>
                                <div class="@error('new_password')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="password" placeholder="Confirmar Senha" id="new_password_confirmation" name="new_password_confirmation">
                                    @error('new_password')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
