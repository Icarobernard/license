                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tipo de oferta</th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID do produto</th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Qtd. Licenças</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($offer->image)
                                            <div>
                                                <img src="{{ asset('storage/' . $offer->image) }}" class="avatar avatar-sm me-3" >
                                            </div>
                                            @endif
                                    ...
                                    <td class="text-center">
                                        ...
                                        <p class="text-xs font-weight-bold mb-0">{{ __('vitalício') }}</p>
                                        @else
                                        <p class="text-xs font-weight-bold mb-0">{{ __('Assinatura') }}</p>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ $offer->product->product_id }}</p>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <!-- Link para editar -->
                                            <a href="{{ route('offers.find', $offer->id) }}" class="mx-2" data-bs-toggle="tooltip" data-bs-original-title="Editar oferta">
                                            ...
                                            <form action="{{ route('offers.destroy', $offer->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button data-bs-toggle="tooltip" data-bs-original-title="Deletar oferta" type="submit" class="btn btn-link text-danger m-1" onclick="return confirm('Certeza que quer deletar esta oferta?')">
